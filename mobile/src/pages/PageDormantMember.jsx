  ...
  return (
    <div className={`PageDormantMember`}>
      <section data-seq={`20230522180448`} className={`mt-[27px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
            <div className={`text-center text-[14px] font-[400] leading-[20px] text-[var(--color1)] w-[247px] mx-auto`}>
              안녕하세요.
              <br />
              고객님께서
      ...
      <section data-seq={`20230525213749697`} className={`mt-[24px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
            <div className={`text-[12px] font-[600] text-[var(--color1)]`}>해제 방법</div>
            <div className={`mt-[15px]`}>
              <TabBtnBox theme={`5`} uuid={`a9544032`}>
                ...
                <button>
                  <div className={`Icon`}>
                    <img src={`/icons/zco_27_3.svg`} alt='' />
                  </div>
              ...
              <TabChildBox uuid='a9544032'>
                ...
                <div className={`mt-[27px]`}>
                  <div className={`text-[12px] font-[600] text-[var(--color1)]`}>이메일주소</div>
                  ...
                  <div className={`grid grid-cols-[1fr_auto] items-end justify-center gap-[5px]`}>
                    ...
                    <Btn className={`w-[62px]`} theme={'Dark'} size={'Sm'}>
                      인증완료
                    </Btn>
                  </div>
                ...
                <div className={`On mt-[27px]`}>
                  <div className={`text-[12px] font-[600] text-[var(--color1)]`}>휴대폰번호</div>
                  <div className={`grid grid-cols-[1fr_auto] items-end justify-center gap-[5px]`}>
                    <TextInputBox>
                ...
                <div className={`mt-[27px]`}>
                  <TabBtnBox theme={`5`}>
                    ...
                    <button className={`rounded-[10px] bg-black before:!hidden`}>
                      <div className={`Icon`}>
                        <img src={`/icons/zco_27_4.svg`} alt='' />
                      </div>
      ...
      <section data-seq={`20230525213722492`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
...
PageDormantMember.Layout = LayoutSub;
