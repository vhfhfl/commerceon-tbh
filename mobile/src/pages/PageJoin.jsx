...
function PageJoin() {
  return (
    <div className={`PageJoin`}>
      <section data-seq={`20230526082056022`} className={`mt-[27px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
            ...
            <div>
              ...
              <div className={`mt-[20px] flex flex-row items-center justify-between`}>
                <div className={`text-[12px] font-[600] text-[var(--color1)]`}>휴면회원 방지기간</div>
                <div className={`ml-[10px] flex flex-row items-center justify-center gap-[12px]`}>
                  <RadioBtn size={`Sm`} name={`83ac7dba`}>
                    1년
                  </RadioBtn>
                  <RadioBtn size={`Sm`} name={`83ac7dba`}>
                    3년
      ...
      <section data-seq={`20230526082056022`} className={`mt-[50px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
            <div className={`FormTitle1`}>
            ...
            <div className={`mt-[20px] flex flex-row items-center justify-between`}>
              <div className={`text-[12px] font-[600] text-[var(--color1)]`}>결혼 여부</div>
              <div className={`ml-[10px] flex flex-row items-center justify-center gap-[12px]`}>
                <RadioBtn size={`Sm`} name={`83ac7dba`}>
                  미혼
                </RadioBtn>
          ...
          <div className={`Inner`}>
            ...
            <div data-seq={`20230526091345135`} className={`mt-[8px]`}>
              ...
              <div>
                <CheckBox1 size={`Sm`}>
                  <div className={`translate-y-[8px]`}>
                    TBH SHOP의 모든 약관을 확인하고 전체 동의합니다.
                    <br />
                    (전체동의, 선택항목도 포함됩니다.)
                  </div>
                </CheckBox1>
              ...
              <div className={`mt-[30px]`}>
                <Btn size={'Sm'} theme={'Dark'} className={`w-full`}>
                  가입완료
                </Btn>
              </div>
            </div>
