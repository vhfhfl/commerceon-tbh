import LayoutSub6 from '@/layouts/LayoutSub7';
import { Fragment } from 'react';

function PageBestReview3() {
  return (
    <div className={`PageBestReview3`}>
      <section data-seq={`20230808184238`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
      ...
      <section data-seq={`20230808234623`}>
        <div>
          <img src={`https://picsum.photos/360/400.jpg?random=1`} alt={``} />
        </div>
      </section>
      <section data-seq={`20230808234735`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
...
PageBestReview3.Layout = LayoutSub6;
export default PageBestReview3;
