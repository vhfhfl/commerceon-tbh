...
function PageEventView3() {
  return (
    <div className={`PageEventView3`}>
      <section data-seq={`20230727103605`} className={`mt-[20px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
      ...
      <section data-seq={`20230727103615`} className={`sticky top-[60px] left-0 z-20 mt-[80px]`}>
...
PageEventView3.Layout = LayoutSub4;
