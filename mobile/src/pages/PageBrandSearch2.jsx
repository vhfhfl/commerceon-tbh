...
function PageBrandSearch2() {
  return (
    <div className={`PageBrandSearch2`}>
      <section data-seq={`20230728141656`} className={`mt-[40px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
      ...
      <section data-seq={`20230728141700`} className={`mt-[5px]`}>
        <CustomSelect3 optionsdata={Data.exhibitionList}></CustomSelect3>
      </section>
      <section data-seq={`20230728141703`} className={`mt-[54px]`}>
        <div className={`H-Box`}>
          <div className={`Inner`}>
...
PageBrandSearch2.Layout = LayoutSub3;
