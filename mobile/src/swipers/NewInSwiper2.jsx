...
function NewInSwiper2(props) {
  const { children, className = '' } = props;

  const dummy_data = Array.from(Array(10));

  return (
    <div {...props} className={`NewInSwiper2 ${className}`}>
      <Swiper
        {...props}
          ...
          return (
            <SwiperSlide key={idx}>
              ...
              <div className={`mt-[20px]`}>
                <div className={`Montserrat text-[12px] font-[600] text-[var(--color1)]`}>MIND BRIDGE ({idx + 1})</div>
                ...
                <div className={`mt-[20px] text-[0px]`}>
                  <div className={`PriceBox Montserrat`}>
                    ...
                    <div className={`text-[var(--color5)]`}>50%</div>
                  </div>
                </div>
              </div>
            </SwiperSlide>
