  ...
  return (
    <>
      ...
      <div
        ...
        <div className={`RRR grid h-full grid-cols-[1fr_auto] items-center justify-between gap-[0] pr-[16px]`}>
          <div className={`min-w-[0]`}>
            <Swiper
              direction={'vertical'}
              className='HeaderLineBanner3Swiper !pl-[20px] h-[var(--header-line-banner3-hei)]'
              modules={[Autoplay]}
              // navigation={true}
              // pagination={true}
              autoplay={{
          ...
          <div>
            <button
              className={`flex h-[var(--header-line-banner3-hei)] w-[var(--header-line-banner3-hei)] flex-row items-center justify-center`}
              onClick={(evt) => {
