...
function HeaderLogoBar2(props) {
  const { className = '' } = props;

  return (
    <>
      <div {...props} className={`HeaderLogoBar2 ${className}`} id='HeaderLogoBar2'>
            ...
            <div className={` flex flex-row items-center justify-between`}>
              ...
              <div>
                <div className={`flex flex-row items-center justify-center`}>
                  <Link href={`#`} className={`RR ml-[8px] block h-[var(--header-logo-bar2-child-hei)] w-[var(--header-logo-bar2-child-hei)]`}>
