...
function ProductItem6(props) {
  ...
  return (
    <>
      <div className={`ProductItem6 ${className}`}>
              ...
              <Fragment key={idx}>
                <div className={`relative`}>
                  ...
                  <article className={`grid grid-cols-[70px_1fr] gap-[10px]`}>
                    <div>
                      <img
                        className={`aspect-[70/92]`}
                        src={`https://picsum.photos/70/92.jpg?random=${idx}`}
                        alt={``}
                      />
                    </div>
                    <div className={`min-w-[0]`}>
                      <div className={`Montserrat mr-[30px] text-[12px] font-[600] text-[var(--color1)]`}>
                        MIND BRIDGE
                      </div>
                      <div className={`mt-[8px] mr-[30px] truncate text-[12px] font-[400] text-[var(--color1)]`}>
