...
function ProductItem3(props) {
  ...
  return (
    <>
      <div className={`ProductItem3 ${className} w-full`}>
        <div className={`relative w-full`}>
          ...
          {idx == 1 && (
            <div
              className={`Montserrat absolute bottom-0 left-0 z-10 w-full bg-[rgba(255,255,255,0.7)] py-[10px] text-center text-[11px] font-[600] text-[var(--color1)]`}>
              <div>TIMESALE</div>
              <article className={`mt-[12px] flex flex-row items-start justify-center gap-[6px]`}>
                <div>
                  <div className={`text-[12px] font-[600]`}>1</div>
                  <div className={`mt-[10px] text-[10px] font-[500]`}>hours</div>
                </div>
                <div>
                  <div className={`text-[12px] font-[400]`}>:</div>
                  <div></div>
                </div>
                <div>
                  <div className={`text-[12px] font-[600]`}>23</div>
                  <div className={`mt-[10px] text-[10px] font-[500]`}>minutes</div>
                </div>
                <div>
                  <div className={`text-[12px] font-[400]`}>:</div>
                  <div></div>
                ...
                <div>
                  <div className={`text-[12px] font-[600]`}>45</div>
                  <div className={`mt-[10px] text-[10px] font-[500]`}>seconds</div>
                </div>
              </article>
            </div>
          )}
          ...
          <div className={`mt-[16px] space-y-[6px]`}>
            <div className={`flex flex-row items-center gap-0`}>
              <div className={`flex flex-row flex-wrap items-center gap-[5px]`}>
                {['#6C6960', '#E4A010', '#CB3234', '#008F39', '#C93C20', '#A18594', '#9C9C9C'].map((obj, idx) => {
                  return (
                    <Fragment key={idx}>
            ...
            <div className={`flex flex-row items-center gap-0`}>
              <div className={`flex flex-row flex-wrap items-center gap-[5px]`}>
                {['#2F353B', '#6C6960', '#E4A010', '#CB3234', '#008F39', '#C93C20'].map((obj, idx) => {
                  return (
                    <Fragment key={idx}>
                      <div className={`aspect-square w-[16px] rounded-full`} style={{ backgroundColor: obj }}></div>
                    </Fragment>
