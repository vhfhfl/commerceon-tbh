...
function ProductItem16(props) {
  const { className = '', idx } = props;

  return (
    <>
      <div
        className={`ProductItem16 ${className} border-y-[1px] border-solid border-t-[var(--color1)] border-b-[var(--color6)]`}>
                    ...
                    <div className={`mt-[18px]`}>
                      <div className={`var(--color1) text-[12px]`}>
                        <div className={`grid grid-cols-[80px_1fr] items-start gap-0`}>
                          ...
                          <div>
                            <button className={`ButtonStyle2 ButtonMd Round w-[110px]`}>옵션선택</button>
                          </div>
                        </div>
                        <div className={`mt-[18px]`}>
                          <div className={`grid grid-cols-[80px_1fr] items-start gap-0`}>
