...
function ColorChip16() {
  return (
    <>
      <div className={`ColorChip16`}>
        <article className={`inline-grid grid-cols-7 gap-[5px]`}>
          {Data.colorList.map((obj, idx) => {
            ...
            return (
              <Fragment key={idx}>
                <button
                  className={`ColorButton16`}
                  style={{ color: chk_color, backgroundColor: obj, borderColor: border_color }}>
                  <svg className={`w-[6px]`} viewBox='0 0 12 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
