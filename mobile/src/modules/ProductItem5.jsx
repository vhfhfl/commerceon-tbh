  ...
  return (
    <>
      <div className={`ProductItem5 ${className}`}>
        <div className={`mt-[40px] text-[14px] font-[600] text-[var(--color1)]`}>(주)티비에이치글로벌</div>
        <div className={`mt-[20px]`}>
          {Array.from(Array(3)).map((obj, idx) => {
            return (
              <Fragment key={idx}>
                <div className={`border-t-[1px] border-t-[var(--color6)] py-[12px]`}>
                  <div className={`mb-[10px] text-right text-[0px]`}>
                    <button>
