...
function LayerFilter8() {
  return (
    <div className={`LayerFilter8 h-full w-full bg-white`}>
          ...
          <div className={`grid h-full grid-cols-[106px_1fr]`}>
                  ...
                  return (
                    <Fragment key={idx}>
                      <button className={`flex h-[24px] w-full flex-row items-center justify-between`}>
                        <div className={`${obj == '시즌' && `font-[600]`}`}>{obj}</div>
                      </button>
                    </Fragment>
                  );
                })}
            ...
            <div className={`border-l-[1px] border-solid border-l-[var(--color6)] px-[20px] py-[25px]`}>
              <div className={`space-y-[20px]`}>
                <div>
                  <CheckBox>봄/가을</CheckBox>
                </div>
                <div>
                  <CheckBox>여름</CheckBox>
                </div>
                <div>
                  <CheckBox>겨울</CheckBox>
                </div>
                <div>
                  <CheckBox>사계절</CheckBox>
                </div>
              </div>
            </div>
          </div>
