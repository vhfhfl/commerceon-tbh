...
function LayerBestReview2(props) {
  const { className = '' } = props;
  const ref_this = useRef();

  return (
    <>
      <div ref={ref_this} {...props} className={`${className} LayerBestReview2 w-[1200px]`}>
        ...
        <div className={`mt-[20px] bg-white`}>
          <article className={`grid grid-cols-2 items-center gap-0`}>
            <div className={`CenterCenter h-full bg-[var(--color1)] text-white`}>
              <div className={`text-[16px] font-[600]`}>첨부된 포토/동영상이 없는 리뷰입니다.</div>
            </div>
            <div className={`bg-white p-[30px]`}>
              ...
              <div className={`mt-[20px]`}>
                <div className={`border-y-[1px] border-solid border-y-[var(--color6)] py-[20px]`}>
                  <div>
...
export default LayerBestReview2;
