...
function TextInputBox(props) {
  ...
  return (
    <>
      <div ref={ref_this} className={`TextInputBox ${className} pt-[16px]`}>
        <div
          className={`grid h-[54px] grid-cols-[1fr_auto] items-center justify-center border-b-[1px] border-solid border-b-[var(--color6)] [&_>_div]:h-full [&_>_div_>_div]:h-full`}>
          {children.length > 0 ? (
            <>
