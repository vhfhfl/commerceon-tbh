      ...
      <div
        ...
        <div className={`RRR grid h-full grid-cols-[repeat(2,auto)] items-center justify-between gap-[0] pr-[16px]`}>
          <div className={`min-w-[0]`}>
            <Swiper
              className='HeaderLineBanner2Swiper !pl-[20px]'
          ...
          <div>
            <button
              className={`RR flex h-[var(--header-line-banner2-hei)] w-[var(--header-line-banner2-hei)] flex-row items-center justify-center`}
              onClick={(evt) => {
