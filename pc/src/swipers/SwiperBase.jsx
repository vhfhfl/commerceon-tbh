...
function SwiperBase(props) {
  ...
  const pagination_basic = {
    ...
    renderBullet: function (index, className) {
      ...
      return `
      <div class="${className} relative whitespace-nowrap Montserrat font-[600] text-[20px] text-black flex flex-row items-center justify-center">
        <div class="hidden [.Active_>_&]:block">${num}</div>
        <div class="[.Active_>_&]:hidden z-10 absolute w-[7px] h-[7px] bg-black top-1/2 left-1/2 translate-y-[-3px] translate-x-[-3px]"></div>
      </div>`;
    },
  };
  ...
  return (
    <div {...props} className={`SwiperBase relative ${className}`}>
      ...
      <Swiper
        ...
        <div className={`PageNationBox mt-[10px] flex flex-row items-center justify-center gap-[20px]`}></div>
