        ...
        {dummy_data.map((obj, idx) => {
          return (
            <SwiperSlide className={``} key={idx}>
              <div>
                {/*[.MainVisualBanner4_.swiper-slide-active_&]:opacity-100*/}
                <div>
                  <Image
                ...
                <div
                  ...
                  <div className={` ml-[214px] text-[var(--color1)]`}>
        ...
        <div className={`relative`} slot='container-start'>
          <div
            ...
            <div className={`NaviBtn Prev pointer-events-auto ml-[60px] cursor-pointer`}>
              <Image src={`/icons/zco_32_1.svg`} width={32} height={61} alt='' />
            </div>
            <div className={`NaviBtn Next pointer-events-auto mr-[60px] cursor-pointer`}>
              <Image src={`/icons/zco_32_2.svg`} width={32} height={61} alt='' />
            </div>
          </div>
        </div>
      </Swiper>
