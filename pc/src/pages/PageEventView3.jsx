...
function PageEventView3() {
  return (
    <div className={`PageEventView3`}>
      <div className={`SubContainer mt-[110px]`}>
        <section data-seq={`20230727103626`}>
          <div>
            <DetailTitle2 />
          </div>
        ...
        <section data-seq={`20230727103629`} className={`mt-[180px]`}>
              ...
              return (
                <Fragment key={idx2}>
                  <div className={`mb-[120px]`}>
                    ...
                    <article className={`grid grid-cols-5 items-center justify-center gap-x-[12px] gap-y-[70px]`}>
                      {Array.from(Array(10)).map((obj, idx) => {
                        return (
                          <Fragment key={idx}>
...
PageEventView3.Layout = LayoutBasic;
export default PageEventView3;
