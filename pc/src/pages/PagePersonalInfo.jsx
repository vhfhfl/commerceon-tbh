      ...
      <div className={`SubContainer2 mt-[120px]`}>
        <section data-seq={`20230702083816868`} className={``}>
          ...
          <div className={`AgreeBox1 mt-[40px]`}>
              ...
              return (
                <Fragment key={idx}>
                  <p>
                    ...
                    공개함으로써 이용자들이 언제나 용이하게 보실 수 있도록 조치하고 있습니다. 개인정보 처리방침은 정부의
                    법률 및 지침 변경이나 회사의 내부 방침 변경 등으로 인하여 수시로 변경될 수 있고, 이에 따른 개인정보
                    처리방침의 지속적인 개선을 위하여 필요한 절차를 정하고 있습니다. 이용자들께서는 사이트 방문 시
                    수시로 확인하시기 바랍니다.
                  </p>
                  <br />
            ...
            <div className={`mt-[50px] SelectBox1 w-[280px]`}>
              <button>
...
PagePersonalInfo.Layout = LayoutBasic;
