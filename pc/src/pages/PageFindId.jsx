...
function PageFindId() {
  return (
    <div className={`PageFindId`}>
      <div className={`SubPageTitle`}>아이디 찾기</div>
        ...
        <div className={`SubPageContBox1`}>
          ...
          <TabChildBox uuid='43897c49'>
            ...
            <div>
              ...
              <div className={`relative my-[30px] border-t-[1px] border-solid border-t-[var(--color6)] text-center`}>
                <div
                  className={`Montserrat absolute left-1/2 z-10 -translate-x-1/2 -translate-y-1/2 bg-white px-[26px] text-[14px] font-[500] text-[var(--color3)]`}>
                  OR
                </div>
              </div>
              <div>
