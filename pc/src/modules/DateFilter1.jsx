...
function DateFilter1() {
  return (
    <>
      <div className={`DateFilter1`}>
        <table className={`Table1 Left mt-[20px]`}>
          <tbody>
            <tr>
                ...
                <article className={`flex flex-row items-center justify-between gap-[0]`}>
                  ...
                  <div>
                    <article className={`flex flex-row items-center gap-[6px]`}>
                      <div
                        className={`relative flex h-[34px] w-[128px] flex-row items-center gap-[0] bg-[var(--color7)] pl-[12px] pr-[5px]`}>
                        <input
                          type={`text`}
