...
function TableItem4(props) {
  const { className = '', idx = 0 } = props;
  const ref_this = useRef();
  return (
    <>
      <div ref={ref_this} className={`TableItem4 ${className} grid grid-flow-col grid-cols-[90px_1fr_auto] gap-[24px]`}>
        ...
        <div>
          ...
          <div className={`mt-[8px]`}>
            <div
              className={`inline-flex h-[34px] flex-row items-center justify-center gap-[0] rounded-[4px] bg-[var(--color3)] px-[14px] text-[14px] font-[400] text-[var(--color5)]`}>
              품절
            </div>
          </div>
          {/*<div className={`mt-[4px] flex flex-row items-center gap-[15px]`}>*/}
          {/*  <div className={`Montserrat text-[14px] font-[400] leading-[28px] text-[var(--color5)]`}>옵션 : ICE BLUE / 095</div>*/}
