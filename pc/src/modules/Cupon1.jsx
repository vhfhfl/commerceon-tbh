    ...
    <>
      <div className={`Cupon1`}>
        <div className={`rounded-t-[6px] border-[1px] border-b-0 border-[#ececec]`}>
          ...
          <article className={`border-t-[2px] border-dotted border-t-[#161616]`}>
            <button className={`CenterCenter h-[50px] w-full rounded-b-[6px] bg-[#161616] px-[44px]`}>
