...
function ReviewItem2(props) {
  ...
  return (
    <>
      <ul
        ref={ref_this}
        className={`ReviewItem2 ${className} divide-y-[1px] divide-solid divide-[var(--color6)] border-y-[1px] border-solid border-[var(--color6)] `}>
            ...
            <Fragment key={idx}>
              <li className={`py-[26px]`}>
                <div>
                  <article className={`grid grid-cols-[1fr_auto] items-start justify-between gap-[10px]`}>
                    <div>
                      <article className={`CenterLeft`}>
                        ...
                        <div className={`ml-[9px] text-[12px] font-[600] text-[var(--color1)]`}>맘에들어요</div>
                      </article>
                  ...
                  <ul className={`CenterLeft !gap-[10px]`}>
                    {Array.from(Array(3)).map((obj, idx) => {
                      return (
                        <Fragment key={idx}>
                          <li>
                            <div>
                              <img src={`https://picsum.photos/120/120.jpg?random=${idx}`} alt={``} />
                            </div>
                          </li>
                        </Fragment>
                      );
                  ...
                  <div className={`mt-[26px] w-[426px]`}>
                    <TableItem3 />
                  </div>
                  <div className={`mt-[43px]`}>
                    <div
                      className={`w-[770px] border-[1px] border-solid border-[var(--color6)] bg-[var(--color7)] py-[18px] px-[24px] leading-[21px]`}>
