...
function ColorChip30() {
  return (
    <>
      <div className={`ColorChip30`}>
        <article className={`inline-grid grid-cols-10 gap-[5px]`}>
          {Data.colorList.map((obj, idx) => {
            ...
            return (
              <Fragment key={idx}>
                <button
                  className={`ColorButton30`}
                  style={{ color: chk_color, backgroundColor: obj, borderColor: border_color }}>
                  <svg className={`w-[10px]`} viewBox='0 0 12 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
